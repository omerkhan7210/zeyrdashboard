                  ...
                  <div className="table-responsive">
                    <table className="table table-striped o-tbl">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td><img className="product-img" src="assets/img/products/p1.jpg" alt /></td>
                        ...
                        <tr>
                          <td>2</td>
                          <td><img className="product-img" src="assets/img/products/p2.jpg" alt /></td>
                        ...
                        <tr className="line">
                          <td>3</td>
                          <td><img className="product-img" src="assets/img/products/p4.jpg" alt /></td>
