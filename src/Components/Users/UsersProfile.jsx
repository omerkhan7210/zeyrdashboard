    ...
    <div className="breadcrumb-wrapper breadcrumb-contacts">
      <div>
        ...
        <p className="breadcrumbs"><span><a href="index.html">Home</a></span>
          <span><i className="mdi mdi-chevron-right" /></span>Profile
        </p>
      </div>
      <div>
        <a href="user-list.html" className="btn btn-primary">Edit</a>
      </div>
    </div>
                    ...
                    <div className="col-xl-12">
                      ...
                      <div className="card card-default">
                        <div className="card-header justify-content-between mb-1">
                          ...
                          <div>
                            <button className="text-black-50 mr-2 font-size-20"><i className="mdi mdi-cached" /></button>
                            <div className="dropdown show d-inline-block widget-dropdown">
                              <a className="dropdown-toggle icon-burger-mini" href="#" role="button" id="dropdown-notification" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static" />
                        ...
                        <div className="card-body compact-notifications" data-simplebar style={{height: 434}}>
                          <div className="media pb-3 align-items-center justify-content-between">
                            ...
                            <span className=" font-size-12 d-inline-block"><i className="mdi mdi-clock-outline" /> 10
                              AM</span>
                          </div>
                          <div className="media py-3 align-items-center justify-content-between">
                            ...
                            <span className=" font-size-12 d-inline-block"><i className="mdi mdi-clock-outline" /> 9
                              AM</span>
                          </div>
                          <div className="media py-3 align-items-center justify-content-between">
                ...
                <div className="tab-pane-content mt-5">
                  <form>
                    ...
                    <div className="form-group mb-4">
                      ...
                      <input type="text" className="form-control" id="userName" defaultValue="User name" />
                      <span className="d-block mt-1">Accusamus nobis at omnis consequuntur
                        culpa tempore saepe animi.</span>
                    </div>
                    <div className="form-group mb-4">
                      <label htmlFor="email">Email</label>
                      <input type="email" className="form-control" id="email" defaultValue="ekka.example@gmail.com" />
                    </div>
                    <div className="form-group mb-4">
                    ...
                    <div className="d-flex justify-content-end mt-5">
                      <button type="submit" className="btn btn-primary mb-2 btn-pill">Update
                        Profile</button>
                    </div>
                  </form>
                </div>
