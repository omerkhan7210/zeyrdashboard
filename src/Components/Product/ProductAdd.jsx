  ...
  <div className="ec-content-wrapper">
    <div className="content">
      <div className="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="product-list.html" className="btn btn-primary"> View All
          </a>
        </div>
      </div>
      <div className="row">
                    ...
                    <div className="ec-vendor-main-img">
                      <div className="avatar-upload">
                        <div className="avatar-edit">
                          ...
                          <label htmlFor="imageUpload"><img src="assets/img/icons/edit.svg" className="svg_img header_svg" alt="edit" /></label>
                        </div>
                  ...
                  <div className="ec-vendor-upload-detail">
                    <form className="row g-3">
                      ...
                      <div className="col-md-4 mb-25">
                        ...
                        <input type="color" className="form-control form-control-color" id="exampleColorInput1" defaultValue="#ff6191" title="Choose your color" />
                        <input type="color" className="form-control form-control-color" id="exampleColorInput2" defaultValue="#33317d" title="Choose your color" />
                        <input type="color" className="form-control form-control-color" id="exampleColorInput3" defaultValue="#56d4b7" title="Choose your color" />
                        <input type="color" className="form-control form-control-color" id="exampleColorInput4" defaultValue="#009688" title="Choose your color" />
                      </div>
                      <div className="col-md-8 mb-25">
                        <label className="form-label">Size</label>
                        <div className="form-checkbox-box">
                          <div className="form-check form-check-inline">
                            <input type="checkbox" name="size1" defaultValue="size" />
                            <label>S</label>
                          </div>
                          <div className="form-check form-check-inline">
                            <input type="checkbox" name="size1" defaultValue="size" />
                      ...
                      <div className="col-md-12">
                        ...
                        <input type="text" className="form-control" id="group_tag" name="group_tag" defaultValue placeholder data-role="tagsinput" />
                      </div>
                      <div className="col-md-12">
