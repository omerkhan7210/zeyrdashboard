  ...
  <div className="ec-content-wrapper">
    <div className="content">
      <div className="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="product-list.html" className="btn btn-primary"> Edit
          </a>
        </div>
      </div>
      <div className="row">
              ...
              <div className="row">
                      ...
                      <div className="single-product-scroll">
                        <div className="single-product-cover">
                          <div className="single-slide zoom-image-hover">
                            <img className="img-responsive" src="assets/img/products/pd_1.jpg" alt />
                          </div>
                          <div className="single-slide zoom-image-hover">
                            <img className="img-responsive" src="assets/img/products/pd_2.jpg" alt />
                          </div>
                          <div className="single-slide zoom-image-hover">
                            <img className="img-responsive" src="assets/img/products/pd_3.jpg" alt />
                          </div>
                          <div className="single-slide zoom-image-hover">
                            <img className="img-responsive" src="assets/img/products/pd_4.jpg" alt />
                          </div>
                          <div className="single-slide zoom-image-hover">
                            <img className="img-responsive" src="assets/img/products/pd_5.jpg" alt />
                          </div>
                        </div>
                ...
                <div className="col-xl-5 col-lg-6">
                  <div className="row product-overview">
                    <div className="col-12">
                      <h5 className="product-title">Pure Leather Purse for Woman</h5>
                      ...
                      <p className="product-desc">Lorem Ipsum is simply dummy text of the
                      ...
                      <ul className="product-size">
                        <li className="size"><span>S</span></li>
                        <li className="size"><span>M</span></li>
                        <li className="size"><span>L</span></li>
                        <li className="size"><span>XL</span></li>
                      </ul>
                      <ul className="product-color">
                        <li className="color"><span style={{backgroundColor: '#90cdf7'}} /></li>
                        <li className="color"><span style={{backgroundColor: '#ff3b66'}} /></li>
                        <li className="color"><span style={{backgroundColor: '#ffc476'}} /></li>
                        <li className="color"><span style={{backgroundColor: '#1af0ba'}} /></li>
                        <li className="color"><span style={{backgroundColor: '#f887d6'}} /></li>
                      </ul>
                    ...
                    <div className="card-body text-center">
                      <a href="javascript:0" className="text-secondary d-inline-block">
                        <div className="image mb-3">
                          <img src="assets/img/user/u-xl-4.jpg" className="img-fluid rounded-circle" alt="Avatar Image" />
                        </div>
